...
import { SolopreneurHubTabs } from "@/components/workspace/SolopreneurHubTabs";
...
export function RevenueView() {
  ...
  return (
    <>
      ...
      <p className="text-night-text-muted mb-2">Log revenue to keep your Health Score current.</p>
      <SolopreneurHubTabs />
