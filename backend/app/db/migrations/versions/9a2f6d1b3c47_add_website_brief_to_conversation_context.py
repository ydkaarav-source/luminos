"""add website_brief to conversation_context enum

Revision ID: 9a2f6d1b3c47
Revises: 74e57bc2c2d5
...
revision: str = '9a2f6d1b3c47'
down_revision: Union[str, None] = '74e57bc2c2d5'
...
def upgrade() -> None:
    ...
    op.execute("COMMIT")
    op.execute("ALTER TYPE conversation_context ADD VALUE IF NOT EXISTS 'WEBSITE_BRIEF'")
